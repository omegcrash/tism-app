...
export function Content({state}: {state: PolicyUpdateState}) {
  ...
  const links = {
    terms: {
      ...
      to: `https://tism.social/tos`,
      label: _(msg`Terms of Service`),
    },
    privacy: {
      overridePresentation: false,
      to: `https://tism.social/privacy`,
    ...
    guidelines: {
      overridePresentation: false,
      to: `https://tism.social/community-guidelines`,
      label: _(msg`Community Guidelines`),
    },
    blog: {
      overridePresentation: false,
      to: `https://tism.social/about`,
      label: _(msg`About TISM`),
    },
  }
      ...
      <View style={[a.align_start, a.gap_xl]}>
        ...
        <View style={[a.w_full, a.gap_md]}>
          <Button
            ...
            accessibilityHint={_(
              msg`Tap to acknowledge that you understand and agree to these updates and continue using Turtle Island`,
            )}
            color="primary"
            size="large"
            onPress={handleClose}>
